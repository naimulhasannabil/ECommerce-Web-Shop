  ...
  return (
    <header className="bg-white shadow-sm sticky top-0 z-50">
      <div className="container-custom max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between py-3 md:py-4 flex-wrap gap-3">
          {/* Logo */}
          <div className="flex items-center space-x-2 flex-shrink-0">
            <div className="w-8 h-8 bg-primary-500 rounded-lg flex items-center justify-center">
              <span className="text-white font-bold text-lg">F</span>
            </div>
            <span className="text-xl sm:text-2xl font-bold text-dark-gray font-playfair">Furniro</span>
          </div>
          ...
          <button
            ...
            className="md:hidden p-2 text-dark-gray hover:text-primary-500 transition-colors ml-auto"
          >
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden py-4 border-t border-gray-200 space-y-4">
            <div className="px-4 relative">
              ...
              />
              <svg
                className="absolute left-7 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            <div className="flex items-center justify-between pt-4 border-t border-gray-200 px-4">
              <div className="flex items-center space-x-4">
                {/* Added onClick here to fix mobile login modal */}
                <button
                  onClick={toggleLoginModal}
                  className="p-2 text-dark-gray hover:text-primary-500 transition-colors"
                >
